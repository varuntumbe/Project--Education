...
import 'package:mapp/ui/widgets/exception_widget.dart';
          ...
          body: model.state == ViewState.Busy
              ...
              : model.state == ViewState.Error
                  ? Container(
                      alignment: Alignment.center,
                      child:
                          ExceptionWidget(exception_msg: model.error_message),
                    )
                  : Column(
                            ...
                            child: ElevatedButton(
                              ...
                              onPressed: () async {
                                ...
                                await displayTextInputDialog(context,
                                    controller, model.exportListOfQuestions);
                                // Navigator.pushNamed(context, 'googleformflow',
                                //     arguments:
